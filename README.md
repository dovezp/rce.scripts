...
https://github.com/dovezp/rce.scripts/assets/89095890/6ff6d940-545d-4ad1-81cd-f633a51f6b96
* [Reference script, traversing_recursive_depth_first_basic_blocks.py](https://github.com/dovezp/rce.scripts/blob/ida-basicblocks/traversing_recursive_depth_first_basic_blocks.py)
* [Reference script, traversing_recursive_depth_first_basic_blocks_and_removing_invalid_basic_blocks.py](https://github.com/dovezp/rce.scripts/blob/ida-basicblocks/traversing_recursive_depth_first_basic_blocks_and_removing_invalid_basic_blocks.py)

### Visualizing Basic Blocks
* [Refernce script, print_basic_blocks.py](https://github.com/dovezp/rce.scripts/blob/ida-basicblocks/print_basic_blocks.py)
