...
### Create Scruts
* [Reference script, plugin_autostruct.py](https://github.com/dovezp/rce.scripts/blob/ida-autohotkey/plugin_autostruct.py)

### Create Unicode
* [Reference script, plugin_autounicode.py](https://github.com/dovezp/rce.scripts/blob/ida-autohotkey/plugin_autounicode.py)
