...
* [Reference script, clean-block.py](https://github.com/dovezp/rce.scripts/blob/oreans/clean-block.py)
  
  This script processes related to assembly code blocks, filtering specific instructions, and converting the filtered blocks into NASM assembly code for futher optimization.
